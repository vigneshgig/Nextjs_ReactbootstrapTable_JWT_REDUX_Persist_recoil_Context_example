    ...
    return (
        <React.Fragment>
            ...
            <Container>
                ...
                <Row>
                    <Form ref={formRef} validated={validated} id="contact-form" className="contact-form" onSubmit={handleSubmit} >
                        <Row>
                            <Col md={12}>
                                <FormGroup>
                        ...
                        <Row>
                            ...
                            <fieldset>
                                <Form.Group as={Row} className='inputGroup' controlId="validationCustom01" role='form'>
                                    {data.map((item) => (
                        ...
                        <Row>
                            <Col className='columns2' md={12}>
                                <FormGroup controlid="exampleForm.ControlTextarea1" role='form'>
                                    ...
                                    <Form.Control required size="lg" controlid='Message' as="textarea" rows="5" onChange={e => setADD_link(e.target.value)} value={ADD_link} />
                        ...
                        <Row>
                            <Col md={12}>
                                <Button id='main-btn' type="submit" variant="primary" className="btn main-btn float-right">Submit</Button>
                            </Col>
                        </Row>
                    </Form>
                    <i id='message' style={{ 'color ': 'green' }}>{Passed}</i>
                </Row>
            </Container>
